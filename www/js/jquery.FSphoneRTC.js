...
(function($) {
    ...
    function onICESDP(self, sdp) {
    	console.log("ICE SDP = "+sdp);
        self.mediaData.SDP = self.stereoHack(sdp);
        console.log("ICE SDP");
        console.dir(self.mediaData);
    ...
    $.FSRTC.prototype.answer = function(sdp, onSuccess, onError) {
        ...
        */
    	...
    	this.phonertc.receiveMessage({type: 'answer', sdp: sdp});
    	onSuccess();
    };
    ...
    $.FSRTC.prototype.call = function(profile) {
        ...
        var callOptions = {
	      isInitiator:  true, //role === 'caller', // Caller or callee?
	      turn: {
        ...
        var session = new cordova.plugins.phonertc.Session(callOptions);
        this.phonertc = session;
        
        session.on("sendMessage",function(data) {
                console.log("on sendMessage: " + JSON.stringify(data, null, 2));
